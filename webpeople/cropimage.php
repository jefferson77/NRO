...
// SET VARIABLES ///////////////////////////////////////////////////////////////////////////////////
  ...
  $org = $_SERVER['DOCUMENT_ROOT']."/photoraw/".$photoname.".jpg" ; //where the original can be found (incl fullpath);
  $res = $_SERVER['DOCUMENT_ROOT']."/photo/".$photoname.".jpg"; //how the result should be saved (incl fullpath);
...
<table border="0" align="center" cellspacing="1" cellpadding="2">
	<tr align="center">
		<td colspan="2">
			<img src="/photo/<?php echo $photoname ?>.jpg" border="0">
		</td>
	</tr>
</table>
	  <?php
