...
$photofile      = NIVO."photoraw/".$photoname."-b.jpg";
$photofilethumb = NIVO."photoraw/".$photoname."-b-thumb.jpg";
$photoweb       = NIVO."image/rawweb/".$photoname."-b.jpg";
$photowebthumb  = NIVO."image/rawweb/".$photoname."-b-thumb.jpg";
...
switch ($actimage) {
	...
	default:
?>
<fieldset><legend class="orange"><?php echo $detail_05; ?> 2</legend>
