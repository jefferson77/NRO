			...
			### recherche fiche contact
				...
				### si 0 ADD
					if ($FoundCountcontact == 0) {
						...
						$ajout->AJOUTE(array('idmerch', 'idpeople'));
					}
			#/## recherche fiche contact
			} 
			#/## Add fiche contact
		...
		<fieldset>
			...
			if ($_GET['contact'] == 'yes') { 
				### RECHERCHE Contact people
					...
					LEFT JOIN people p ON c.idpeople = p.idpeople 
					LEFT JOIN agent a ON c.idagent = a.idagent 
					WHERE c.idmerch = ".$idmerch." AND c.idpeople = ".$_GET['idpeople'];
				...
				#/## RECHERCHE Contact people
			?>
			<form action="<?php echo $_SERVER['PHP_SELF'].'?&idmerch='.$idmerch.'&act=select&sel=people&etape=listepeople&skip='.$skip.'&contact=modif&idpeople='.$rowcontact1['idpeople']; ?>" method="post">
...
<!--
			<table class="<?php echo $classe; ?>" border="0" width="100%" cellspacing="1" cellpadding="1" align="center">
				<tr>
					<td class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'].'?&idmerch='.$idmerch.'&act=select&sel=people&etape=listepeople&skip='.$skipprev; ?>"><img src="<?php echo STATIK ?>illus/avant.gif" alt="search" width="20" height="20" border="0"></a></td>
					<td class="<?php echo $classe; ?>" align="center"><?php echo $skip;?> - <?php echo $skip+24;?></td>
					<td class="<?php echo $classe; ?>" align="right"><a href="<?php echo $_SERVER['PHP_SELF'].'?&idmerch='.$idmerch.'&act=select&sel=people&etape=listepeople&skip='.$skipnext; ?>"><img src="<?php echo STATIK ?>illus/apres.gif" alt="search" width="20" height="20" border="0"></a></td>
				</tr>
			</table>
-->
...
$classe = "white";
		...
		?>
				<tr>
					...
					<td class="<?php echo $classe; ?>">
						<?php ### CONTACT people ?>
						<a href="<?php echo $_SERVER['PHP_SELF'].'?&idmerch='.$idmerch.'&act=select&sel=people&etape=listepeople&skip='.$skip.'&contact=yes&idpeople='.$row['idpeople']; ?>">
