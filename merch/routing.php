...
function gdist ($destfromlat, $destfromlong, $desttolat, $desttolong) {
	...
	return round($dist * 1.7); ## 1.7 etant le coefficient "vol d'oiseau/distance relle"
}
...
### Routing ####################################################################################################################################
	...
	<?php
		...
		echo '<div class="ttop">Routing de '.$idp['pprenom'].' '.$idp['pnom'].'</div>';
	...
	## Periode
		...
		} elseif ((!empty($_GET['din'])) and (!empty($_GET['dout']))) {
			$datein  = $_GET['din'];
			$dateout = $_GET['dout'];
		}
...
#		}
		...
		echo '<div class="tdate">Periode du '.fdate($datein).' au '.fdate($dateout).'</div>';
...
?>
		...
		<td class="data"><input type="text" size="6" name="h1" value="<?php echo ftime($d['h1']); ?>"<?php echo $disf; ?>></td>
		<td class="data"><input type="text" size="6" name="h2" value="<?php echo ftime($d['h2']); ?>"<?php echo $disf; ?>></td>
<?php if ($d['secteur'] == 'VI') { ?>
		<td class="data">B<input style="width: auto;" type="text" size="2" name="hb" value="<?php echo fnbr($d['hb']); ?>"<?php echo $disf; ?>></td>
		<td class="data">N<input style="width: auto;" type="text" size="2" name="hs" value="<?php echo fnbr($d['hs']); ?>"<?php echo $disf; ?>></td>
<?php } else { ?>
		<td class="data"><input type="text" size="6" name="h3" value="<?php echo ftime($d['h3']); ?>" <?php echo $disf; ?>></td>
		<td class="data"><input type="text" size="6" name="h4" value="<?php echo ftime($d['h4']); ?>" <?php echo $disf; ?>></td>
<?php } ?>
		...
		<td class="dataP"><input type="text" size="6" name="kmp" value="<?php echo $d['kmp']; ?>" <?php echo $disf; ?>></td>
		<td class="data"><?php echo $kmauto; ?></td>
		<td class="data"><?php echo $mapillu; ?></td>
		<td class="dataD"><?php echo fnega10($diff); ?></td>
		<td class="data"><input type="submit" class="btn send" <?php echo $disf; ?>></td>
	</tr>
	</form>
<?php
	...
	<tr>
		...
		<td class="jobtot"></td>
		<td class="jobtotD"><?php echo fnega10($totdiff); ?></td>
		<td class="jobtot"></td>
	</tr>
...
?>
	<tr>
		<td class="bigtot" colspan="10" style="text-align: right;background-color: transparent; padding-right: 5px;">Total</td>
		<td class="bigtotF"><?php echo $totmaxkmf; ?></td>
		<td class="bigtotP"><?php echo $totmaxkmp; ?></td>
		<td class="bigtot"><?php echo $totmaxkmauto; ?></td>
		<td class="bigtot"></td>
		<td class="bigtotD"><?php echo fnega10($totmaxdiff); ?></td>
		<td class="bigtot"></td>
	</tr>
