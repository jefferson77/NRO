 ...
 <h1 style="font-size: 150%;">Upload Multiple Files at Once:</h1>
  <div style="width: 40em; border: 3px ridge #ff0000; padding: .5em">
    <?php for ($i=0; $i < $upload_fields; $i++) { ?>
      <form METHOD="POST" enctype="multipart/form-data" name="form<?php echo $i; ?>" id="form<?php echo $i; ?>" action="/cgi/lightupload/upload.cgi?sID=<?php echo $session; ?>form<?php echo $i; ?>" target="form<?php echo $i; ?>_iframe">
