	...
	<table class="<?php echo $classe; ?>" border="0" width="98%" cellspacing="1" cellpadding="1" align="center">
		...
		?>
				...
				?>
						...
						<td class="<?php echo $classe; ?>"><input type="radio" name="factswitch-<?php echo $row['idanimation'] ?>" <?php echo $checkedfl ;?> value="9"></td>
						...
						<td class="<?php echo $classe; ?>"><input type="radio" name="factswitch-<?php echo $row['idanimation'] ?>" <?php echo $checkedsb ;?> value="20"></td>
					</tr>
						<tr bgcolor="gray">
							<td colspan="16">
