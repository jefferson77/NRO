...
<?php $colspa = 8;?>
	<table class="<?php echo $classe; ?>" border="0" width="98%" cellspacing="1" cellpadding="1" align="center">
		<tr>
		<?php  $colspa = 9;?>
			<th class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'];?>?act=purgeout2&action=skip&sort=me.idmerch">Mission</a></th>
			<th class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'];?>?act=purgeout2&action=skip&sort=me.datem">Date</a></th>
			<th class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'];?>?act=purgeout2&action=skip&sort=p.pnom">People</a></th>
			<th class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'];?>?act=purgeout2&action=skip&sort=c.idclient">Clients</a></th>
			<th class="<?php echo $classe; ?>"><a href="<?php echo $_SERVER['PHP_SELF'];?>?act=purgeout2&action=skip&sort=s.codeshop">Lieux</a></th>
		...
		?>
				...
				?>
						...
						<td class="<?php echo $classe; ?>"><input type="radio" name="factswitch-<?php echo $row['idmerch'] ?>" <?php echo $checkedout ;?> value="26"></td>
						<td class="<?php echo $classe; ?>"><input type="radio" name="factswitch-<?php echo $row['idmerch'] ?>" <?php echo $checkedback ;?> value="1"></td>
						<td class="<?php echo $classe; ?>"><input type="radio" name="factswitch-<?php echo $row['idmerch'] ?>" <?php echo $checkedsb ;?> value="25"></td>
					</tr>
		<?php 
		$xpnom = $pnom ;
		} ?>
