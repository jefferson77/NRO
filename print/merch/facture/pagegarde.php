...
#/ ## Sur les prints , si non assujetti => mettre la mention : BE N.A. (2005-09-16)
	...
	pdf_show_boxed($pdf, "\r".utf8_decode($fac->societe)." (".utf8_decode($fac->idclient).")
".utf8_decode($fac->dept)."
".$phrase[62]."  ".utf8_decode($fac->qual)." ".utf8_decode($fac->nom)."
".utf8_decode($fac->adresse)." 
".utf8_decode($fac->pays)."
".utf8_decode($fac->ftva)." ".utf8_decode($astva)."
...
#	 														#
	...
	pdf_show_boxed($pdf, utf8_decode($fac->Detail['frais']) , 100 , 435 , 300, 30 , 'left', ""); 	# Detail Frais
