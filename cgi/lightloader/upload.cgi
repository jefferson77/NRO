...
#############
# SETTINGS! #Header("Location:http://".$_SERVER['HTTP_HOST']."/menu.php");
#############
$max_upload = 60000000; # Set this to whatever you feel suitable for you.
$tmp_dir="/NRO/tmp"; # If you change this you need to change it in filestatus.php too.
...
while (read (STDIN ,$LINE, 4096) && $bRead < $len )
{
	...
	select(undef, undef, undef, 0.18);	# sleep for 0.35 of a second.
